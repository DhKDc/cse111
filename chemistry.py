...
def main():
    try:
        ...
        formula_input = input("Enter the chemical formula for a molecule: ")

        # Get the mass of a chemical sample in grams from the user.
        mass_input = float(input("Enter the mass of the chemical sample in grams: "))

        # Call the make_periodic_table function and store the periodic table in a variable.
        periodic_table = make_periodic_table()

        # Call the parse_formula function to convert the chemical formula to a symbol_quantity_list.
        ...
        number_of_moles = mass_input / molar_mass
        ...
        # Print the formatted molar mass.
        print(f"Molar Mass: {molar_mass:.5f} grams/mole")

        # Print the formatted number of moles.
        print(f"Number of Moles: {number_of_moles:.2f} moles")
